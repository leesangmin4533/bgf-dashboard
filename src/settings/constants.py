...
# DB 스키마 버전
# =====================================================================
DB_SCHEMA_VERSION = 77  # v77: product_details PK를 (store_id, item_cd)로 변경 — 매장별 orderable_day 분리
...
BUNDLE_SUSPECT_MID_CDS = {
    ...
    # 라면/면류
    "006", "032",
    # 식육가공 (햄/소시지/베이컨) — 04-08 49965 8801392060632 과발주
    "023", "024", "025",
}
...
# STOP_RECOMMEND 자동 확정 (order-unit-guard)
STOP_RECOMMEND_AUTO_CONFIRM_DAYS = 7     # STOP_RECOMMEND 후 N일 + 판매0 → 자동 CONFIRMED_STOP
STOP_RECOMMEND_AUTO_CONFIRM_ENABLED = True  # 자동 확정 활성화
